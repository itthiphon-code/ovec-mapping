...
const faqs = [
  [
    ...
    "ค้นเพื่อศึกษาข้อมูลได้ แต่การยื่นคำร้องต้องใช้ใบรับรองที่เป็นของผู้ยื่นจริง หากกำลังตัดสินใจเข้าสอบ ควรให้สถานศึกษาตรวจรายวิชาและเกณฑ์ที่ใช้ก่อนเสียค่าใช้จ่าย คะแนนในระบบไม่รับประกันผลเทียบโอน",
  ],
  [
  ...
  [
    "คะแนนความคล้ายสูง หมายถึงเทียบผ่านเลยหรือไม่",
    "ยังไม่ใช่ผลอนุมัติ คะแนนเปรียบเทียบความหมายของข้อความระหว่างมาตรฐานกับรายวิชา ผู้เชี่ยวชาญต้องตรวจขอบเขต เอกสารต้นฉบับ หลักฐานปฏิบัติ และเกณฑ์ของสถานศึกษาก่อน",
  ],
  [
