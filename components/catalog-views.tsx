  ...
  return (
    <>
      ...
      <section className="panel text-section">
        <h2>มีใบรับรองที่สอบผ่านแล้ว เริ่มตรงนี้</h2>
        <ol>
          <li>
            เปิด <Link href="/">ใบรับรองเทียบวิชาอะไร</Link>{" "}
            แล้วค้นชื่ออาชีพตามใบรับรอง TPQI
          </li>
          <li>
            เลือกระดับและ UoC ที่สอบผ่านจริง ระบบแสดงรายวิชาที่คัดไว้ทันที
          </li>
          <li>
            ดูเปอร์เซ็นต์ความคล้าย หลักฐานรายข้อ และหน่วยที่ยังขาด
            พิมพ์ผลเพื่อประกอบการตรวจได้
          </li>
          <li>
            กด “เตรียมคำร้องวิชานี้” ระบบกรอกรหัสวิชาและขอบเขตที่เลือกให้
            จากนั้นแนบใบรับรองเพื่อให้ผู้เชี่ยวชาญตรวจ
          </li>
        </ol>
        <p>
          การเลือกหน่วยเป็นข้อมูลที่ผู้ใช้ระบุ
          ยังไม่ได้ยืนยันความแท้ของใบรับรองหรืออนุมัติหน่วยกิต
          ผลละเอียดจำกัดอยู่ในชุดรายวิชาที่คัดไว้ต่อระดับ
        </p>
      </section>
      <section className="panel text-section">
        <h2>เปิดผลจับคู่ที่คำนวณไว้แล้ว</h2>
        <ol>
          <li>
            เปิดเมนู <Link href="/automatic">ผลจับคู่ทั้งคลัง</Link>{" "}
            จะเห็นเปอร์เซ็นต์และคู่มาตรฐานทันที
          </li>
          <li>ค้นด้วยรหัส ชื่อวิชา สาขา หรือกรองระดับและหลักฐานอ้างอิง</li>
          <li>
            คลิก “เปิดผล” เพื่อดูคู่มาตรฐานทางเลือก ตาราง UoC/EoC/เกณฑ์
            และหลักฐานรายวิชา
          </li>
          <li>
            พิมพ์ผลได้ทันที หากต้องการจัดทำการรับรอง ให้กด
            “นำผลนี้ไปจัดทำหลักฐานรับรอง” แล้วตรวจและส่งผู้เชี่ยวชาญ
          </li>
        </ol>
        <p>
          ไม่ต้องดาวน์โหลดโมเดลหรือเริ่มคำนวณเป็นรายวิชา
          คะแนนเป็นข้อเสนอจากความใกล้เคียงข้อความ ยังไม่ใช่ผลเทียบโอนที่รับรอง
        </p>
      </section>
